    ...
    <div>
        ...
        <main>
            <div class=" main">
                <div class="main__desc">
                    ...
                    <div class="main__btn">
                        <router-link :to="url">
                            ...
                            <svg class="main__desc_btn-img" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                viewBox="0 0 18 17" fill="#f0a350">
                ...
                <div>
                    <img class="main__img" src="../assets/img/main.jpg" alt="">
                </div>
            </div>
        </main>
        <MenuSlider />
            ...
            <div class="count">
                <div class="count__counter">
                    <div class="count__counter_block">
                        <h3 class="count__num">5</h3>
                        <p class="count__text">Медицинских организаций</p>
                    </div>
                    <div class="count__counter_block">
                        <h3 class="count__num">18</h3>
                        <p class="count__text">Поликлиник</p>
                    </div>
                    <div class="count__counter_block">
                        <h3 class="count__num">600</h3>
                        <p class="count__text">Врачей</p>
                    </div>
                    <div class="count__counter_block">
                        <h3 class="count__num">200+</h3>
                        <p class="count__text">Довольных пациентов</p>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    components: { Start, End, MenuSlider},
    data() {
        return {
            url: '/login'
        }
